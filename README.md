...
| **RNF09** | **Não Funcional** | O *software* deve ser projetado com alta coesão e baixo acoplamento entre os módulos, utilizando interfaces bem definidas para facilitar futuras expansões e manutenções sem impacto em outras partes do sistema. | Média | Em andamento      | [🟩🟩🟩🟥🟥] 60%      | Entrega 2           | Estruturação de código usando orientação a objetos com interfaces claras. |
